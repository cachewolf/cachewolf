...
//	  public static final float NaN = NaN.0F;
   ...
   private int bitCount;
    ...
    public int compareTo(Object val) {    	
        if (signum == ((BigInteger)val).signum) {
            switch (signum) {
            case 1:
                return compareMagnitude((BigInteger) val);
            case -1:
                return ((BigInteger)val).compareMagnitude(this);
            default:
                return 0;
            }
        }
        return signum >  ((BigInteger)val).signum ? 1 : -1;
    }
	...
	if (staticRandom == null) {
	    staticRandom = new ewe.security.SecureRandom();
	}
	return staticRandom;
    }
