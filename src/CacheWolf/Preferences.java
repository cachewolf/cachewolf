...
public class Preferences extends MinML {
    ...
    /**
     * How GC will display a date. This value is read from GCs userpreference.
     * Currently we will only support "MM/dd/yyyy", "dd/MM/yyyy", "dd.MM.yyyy"
     */
    private String gcDateFormat = "MM/dd/yyyy";
    /**
     *
     */
     ...
     * @param withStackTrace If true and the debug switch is true, the stack trace is appended to the log The debug switch can be set by including the line <i>&lt;debug value="true"&gt;&lt;/debug&gt;</i> in the pref.xml file or by manually setting it (i.e. in
    ...
    public void setGcDateFormat (String dateFormat){
	gcDateFormat = dateFormat;
    }

    public String getGcDateFormat (){
	return gcDateFormat;
    }
}
