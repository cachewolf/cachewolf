...
public class GpxExportNg {
	...
	try {
	    ...
	    // tempor�res Verzeichnis l�schen (wird bei gpi nicht mehr gebraucht)
	    if (outputStyle == OUTPUT_POI) {
	...
	if (ch.isSolved()) {
	    // wir kennen die OriginalKoordinaten nicht, aber es gibt wohl nichts f�r nur corrected coordinates
	...
	*/
	...
	private String getOutputTo(int what) {
		...
		fc.setTitle(MyLocale.getMsg(616, "Verzeichnis ausw�hlen"));
	    } else {
