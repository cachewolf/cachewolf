	...
	public void onEvent(Event ev){
		if (ev instanceof ControlEvent && ev.type == ControlEvent.PRESSED){
			...
			if (ev.target == applyB){
				...
				myPreferences.tablePrefs[1] = (dif.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[2] = (ter.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[5] = (loc.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[6] = (own.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[7] = (hid.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[8] = (stat.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[9] = (dist.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[10] = (bear.getState()==true ? 1 : 0);
