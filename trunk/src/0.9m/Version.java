...
public class Version {
	...
	static final String VER_BUILD = " RC8";
	static final String VER_SVN ="$LastChangedRevision: 236 $"; // the number is automatically replaced by subversion to the latest versionnumer of this file (svn:keywords LastChangedRevision)
