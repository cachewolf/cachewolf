...
public class MainForm extends Editor {
	...
	public MainForm(boolean dbg, String pathtoprefxml) {
		...
		Global.pref.setPathToConfigFile(pathtoprefxml); // in case pathtoprefxml == null the preferences will determine the path itself
		doIt();
	}
	...
	public void doIt() {
		...
		if (Global.pref.showStatus)
			statBar = new StatusBar(Global.profile.cacheDB);
