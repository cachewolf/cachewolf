...
td { font-size:small;  }
@media screen {.clickHint {font-family: Arial; font-size:xx-small; padding-left:30px; display:inline; } }
@media print {.clickHint {font-family: Arial; font-size:xx-small; display:none; }
</style>
<head>
