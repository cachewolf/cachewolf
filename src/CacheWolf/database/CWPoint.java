...
public class CWPoint extends CoordinatePoint {
	...
	*/
    ...
    public String getLatDeg(int format) {
        switch (format) {
            case TransformCoordinates.DD:
                return Common.formatDouble(this.latDec, "00.00000").replace(',', '.');
            case TransformCoordinates.DMM:
            case TransformCoordinates.DMS:
    ...
    public String getLonDeg(int format) {
        switch (format) {
            case TransformCoordinates.DD:
                return Common.formatDouble(this.lonDec, "000.00000").replace(',', '.');
            case TransformCoordinates.DMM:
            case TransformCoordinates.DMS:
        ...
        switch (format) {
            ...
            case TransformCoordinates.DMM:
                ...
                switch (what) {
                    ...
                    case 1:
                        return Common.formatDouble(tmpMin, "00.000").replace(',', '.');
                    case 2:
                        return "";
                }
            case TransformCoordinates.DMS:
                ...
                switch (what) {
                    case 0:
                        return MyLocale.formatLong(iDeg, "00");
                    case 1:
                        return Common.formatDouble(tmpMin, "00");
                    case 2:
                        return Common.formatDouble(tmpSec, "00.00").replace(',', '.');
                }
        }
