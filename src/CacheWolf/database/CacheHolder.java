...
public class CacheHolder {
     ...
     * return this object, otherwise it will create it and try to read it from the corresponding <waypoint>.xml file. Depending on the parameters it is allowed that the <waypoint>.xml file does not yet exist, or the user is warned that the file
     * doesn't exist. If more than <code>maxdetails</code> details are loaded, then the 5 last recently loaded caches are unloaded (to save ram).
     * 
     * @param alarmuser
    ...
    /**
     * Returns <code>true</code> if the waypoint should appear in the cache list,<br>
     ...
     * 
     * @param level
     *            4=isIncomplete(), 3=isNew(), 2=isUpdated(), 1=isLogUpdated
     * @param fm
     *            Font metrics
