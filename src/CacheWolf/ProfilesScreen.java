...
public class ProfilesScreen extends Form {
	...
	*/
	public ProfilesScreen(Preferences myp){
		myPrefs = myp;
		this.title = (String)lr.get(1100,"Profiles");
		
		//this.addLast(new mLabel((String)lr.get(1101,"Profile 1")));
		this.addNext(new mLabel((String)lr.get(1101,"Profile 1")));
		...
		this.addLast(but1 = new mButton((String)lr.get(1105,"Browse")));
		name1.setText(myPrefs.profiles[0]);
		dir1.setText(myPrefs.profdirs[0]);
		
		//this.addLast(new mLabel((String)lr.get(1102,"Profile 1")));
		this.addNext(new mLabel((String)lr.get(1102,"Profile 2")));
		...
		this.addLast(but2 = new mButton((String)lr.get(1105,"Browse")));
		name2.setText(myPrefs.profiles[1]);
		dir2.setText(myPrefs.profdirs[1]);
		
		//this.addLast(new mLabel((String)lr.get(1103,"Profile 1")));
		this.addNext(new mLabel((String)lr.get(1103,"Profile 3")));
		...
		this.addLast(but3 = new mButton((String)lr.get(1105,"Browse")));
		name3.setText(myPrefs.profiles[2]);
		dir3.setText(myPrefs.profdirs[2]);
		
		//this.addLast(new mLabel((String)lr.get(1104,"Profile 1")));
		this.addNext(new mLabel((String)lr.get(1104,"Profile 4")));
		...
		this.addLast(but4 = new mButton((String)lr.get(1105,"Browse")));
	...
	*/
	...
	private void getCoords(mButton btn,int idx){
		...
		if (cs.execute()== IDOK){
			...
			myPrefs.mylgNS = profCoords.getNSLetter();
			myPrefs.mylgDeg = profCoords.getLatDeg(CWPoint.DMM);
			myPrefs.mylgMin = profCoords.getLatMin(CWPoint.DMM);
			myPrefs.mybrWE = profCoords.getEWLetter();
			myPrefs.mybrDeg = profCoords.getLonDeg(CWPoint.DMM);
			myPrefs.mybrMin = profCoords.getLonMin(CWPoint.DMM);
		}
