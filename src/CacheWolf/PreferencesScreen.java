...
public class PreferencesScreen extends Form {
	...
	public PreferencesScreen (Preferences pref){
		...
		this.addNext(new mLabel((String)lr.get(601,"Your Alias:")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addLast(new mLabel("Browser:"),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));

		Alias = new mInput();
		Browser = new mInput();
		Alias.setText(myPreferences.myAlias);
		Browser.setText(myPreferences.browser);
		this.addNext(Alias,CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		//this.addNext(Alias.setTag(Control.SPAN, new Dimension(3,1)),this.DONTSTRETCH, (this.HFILL|this.WEST));
		this.addNext(Browser,CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addLast(gpsB = new mButton("GPS"),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));

		// display some things only, if no profile is active
		if (pref.currProfile == 0){
			this.addLast(new mLabel((String)lr.get(602,"Your Location:")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			this.addNext(NS = new mChoice(new String[]{"N", "S"},0),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			if(myPreferences.mylgNS.equals("N")) NS.setInt(0);
			else NS.setInt(1);
			this.addNext(NSDeg = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			NSDeg.setText(myPreferences.mylgDeg);
			this.addLast(NSm = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			NSm.setText(myPreferences.mylgMin);
			this.addNext(EW = new mChoice(new String[]{"E", "W"},0),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			if(myPreferences.mybrWE.equals("E")) EW.setInt(0);
			else EW.setInt(1);
			this.addNext(EWDeg = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			EWDeg.setText(myPreferences.mybrDeg);
			this.addLast(EWm = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			EWm.setText(myPreferences.mybrMin);
			this.addNext(new mLabel((String)lr.get(603,"Data Directory:")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			this.addLast(brwBt = new mButton((String)lr.get(604,"Browse")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
			DataDir = new mInput();
			DataDir.setText(myPreferences.mydatadir);
			this.addLast(DataDir.setTag(Control.SPAN, new Dimension(3,1)),CellConstants.DONTSTRETCH, (CellConstants.HFILL|CellConstants.WEST));
		}
		...
		this.addNext(new mLabel("Proxy"),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addNext(new mLabel("Port"),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addLast(new mLabel("Font"),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addNext(Proxy = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.HFILL|CellConstants.WEST));
		Proxy.setText(myPreferences.myproxy);
		this.addNext(ProxyPort = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.HFILL|CellConstants.WEST));
		this.addLast(fontSize = new mInput(),CellConstants.DONTSTRETCH, (CellConstants.HFILL|CellConstants.WEST));
		ProxyPort.setText(myPreferences.myproxyport);
		fontSize.setText(Convert.toString(myPreferences.fontSize));
		this.addLast(new mLabel((String)lr.get(605,"Display Preferences")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		this.addNext(dif = new mCheckBox((String)lr.get(606,"Difficulty")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[2] == 1) dif.setState(true);
		this.addNext(ter = new mCheckBox((String)lr.get(607,"Terrain")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[3] == 1) ter.setState(true);
		this.addLast(loc = new mCheckBox((String)lr.get(608,"Location")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[6] == 1) loc.setState(true);
		this.addNext(own = new mCheckBox((String)lr.get(609,"Owner")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[7] == 1) own.setState(true); 
		this.addNext(hid = new mCheckBox((String)lr.get(610,"Hidden")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[8] == 1) hid.setState(true);
		this.addLast(stat = new mCheckBox((String)lr.get(611,"Status")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[9] == 1) stat.setState(true);
		this.addNext(dist = new mCheckBox((String)lr.get(612,"Distance")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
		if(myPreferences.tablePrefs[10] == 1) dist.setState(true);
		this.addLast(bear = new mCheckBox((String)lr.get(613,"Bearing")),CellConstants.DONTSTRETCH, (CellConstants.DONTFILL|CellConstants.WEST));
