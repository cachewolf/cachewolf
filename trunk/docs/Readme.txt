...
An weiteren Dateien neben CacheWolf.ewe werden im Programmverzeichnis noch *.def, *.html, *.tpl und attributes/*.gif aus dem Verzeichnis „resources“ benötigt. Wahlweise kann man stattdessen auch resources/attributes-big/*.gif in «Programmverzeichnis»/attributes/ packen.
