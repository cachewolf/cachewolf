...
public class RSADigestSigner
		implements Signer
{
	private AsymmetricBlockCipher rsaEngine = new PKCS1Encoding(new RSABlindedEngine());
	...
	/*
	 * public RSADigestSigner( Digest digest) { this(digest,
	 * (ASN1ObjectIdentifier)oidMap.get(digest.getAlgorithmName())); }
	 */
			...
			byte[] signature)
	{
		...
		{
			Arrays.constantTimeAreEqual(expected, expected); // keep time
																// "steady".
