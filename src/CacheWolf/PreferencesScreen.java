	...
	public void onEvent(Event ev){
		if (ev instanceof ControlEvent && ev.type == ControlEvent.PRESSED){
			...
			if (ev.target == applyB){
				...
				myPreferences.tablePrefs[5] = (own.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[6] = (hid.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[7] = (stat.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[8] = (dist.getState()==true ? 1 : 0);
				myPreferences.tablePrefs[9] = (bear.getState()==true ? 1 : 0);
