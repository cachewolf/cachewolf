...
public class PreferencesScreen extends Form {
	...
	mTab.addCard(pnlGeneral, MyLocale.getMsg(621, "General"), null).iconize(GuiImageBroker.getImage("person"), Global.pref.useIcons);
	...
	*/
	...
	mTab.addCard(pnlDisplay, MyLocale.getMsg(622, "Screen"), null).iconize(GuiImageBroker.getImage("monitor"), Global.pref.useIcons);
	// ///////////////////////////////////////////////////////
	// Card Pages
	// ///////////////////////////////////////////////////////
	...
	mTab.addCard(pnlTabs, MyLocale.getMsg(662, "Pages"), null).iconize(GuiImageBroker.getImage("tabs"), Global.pref.useIcons);
	// ///////////////////////////////////////////////////////
	// Card More
	// ///////////////////////////////////////////////////////
	...
	mTab.addCard(pnlMore, MyLocale.getMsg(632, "More"), null).iconize(GuiImageBroker.getImage("more"), Global.pref.useIcons);
	// ///////////////////////////////////////////////////////
	// Card - Listview
	// ///////////////////////////////////////////////////////
	mTab.addCard(tccList = new TableColumnChooser(//
		...
		}, Global.pref.listColMap), MyLocale.getMsg(595, "List"), null).iconize(GuiImageBroker.getImage("list"), Global.pref.useIcons);
	...
	mTab.addCard(tccBugs = new TableColumnChooser(//
		...
		}, Global.pref.travelbugColMap), "T-bugs", null).iconize(GuiImageBroker.getImage("bug"), Global.pref.useIcons);
